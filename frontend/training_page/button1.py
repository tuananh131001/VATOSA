...
# from frontend.customtkinter.widgets import CTkCanvas
# from frontend.customtkinter.windows. import ThemeManager
# from ..settings import Settings
# from ..draw_engine import DrawEngine
# from .widget_base_class import CTkBaseClass
# from frontend.customtkinter import Settings
...
class Button1():
    ...
    def __init__(self, *args,
        ...
        self.fg_color = "default_theme"
        self.hover_color = hover_color
        self.border_color = border_color
        self.text_color = text_color
        self.text_color_disabled = "default_theme"
        ...
        if self.text is not None and self.text != "":
            ...
            if no_color_updates is False:
                ...
                if self.state == tkinter.DISABLED:
                    self.text_label.configure(fg=self.text_color_disabled)
                else:
                    self.text_label.configure(fg=self.text_color)
    ...
    def on_leave(self, event=None):
        ...
        if self.hover is True:
            ...
            self.canvas.itemconfig("inner_parts",
                                   outline=inner_parts_color,
                                   fill=inner_parts_color)

            # set text_label bg color (label color)
            if self.text_label is not None:
                self.text_label.configure(bg=inner_parts_color)

            # set image_label bg color (image bg color)
            if self.image_label is not None:
                self.image_label.configure(bg=inner_parts_color)
